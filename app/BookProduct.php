...
// implements - указывает на интерфейс 
    ...
    public function __toString(){
        // магический метод, который позволяет определить поведение объекта,
        // при его вызове через echo
            return 'class ' . __CLASS__ ;
    }

    public function __get($name){
        // метод используется для определения поведения
        // при обращении к св-ву объекта, которое не определено в его классе.
    }
